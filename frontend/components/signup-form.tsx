        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-3 py-2 pr-10 bg-white border rounded-md text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:border-transparent ${
                  emailStatus.error
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className={`w-full px-3 py-2 bg-white border rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:border-transparent ${
          ...
          <button
            ...
            className={`w-full py-6 text-lg font-medium rounded-lg h-[60px] transition-colors ${
