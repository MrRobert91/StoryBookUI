...
MISSION_PROMPTS = {
    ...
    "big_or_small": (
        ...
        "o hacer grande una semilla para que alimente a muchos pájaros. Enseña la relatividad del tamaño."
    ),
    "five_senses": (
...
STORY_SYSTEM_PROMPTS = {
    "system": "Eres un experto escritor de cuentos infantiles de fantasía. Escribe un cuento de exactamente {num_chapters} capítulos.",
    "guidelines": (
        "REGLAS IMPORTANTES:\n"
        "- Cada capítulo debe tener aproximadamente {words_per_chapter} palabras\n"
        "- El contenido debe ser apto para toda la familia y apropiado para niños\n"
        "- Usa descripciones coloridas e imaginativas\n"
        "- Incluye mensajes positivos y personajes amigables\n"
        "- Devuelve un JSON estructurado con 'title' y un array de 'chapters'\n"
        "- Cada capítulo debe tener los campos 'title' y 'content'"
    ),
    "image_system": (
        "Crea un prompt de imagen conciso adecuado para libros infantiles. "
        "El resultado DEBE describir una ilustración coherente con el estilo visual solicitado. "
        "Céntrate en describir la escena, los personajes y las emociones de forma clara para un público joven. "
...
GUIDED_STORY_FORMAT = {
    "system": "Eres un experto escritor de cuentos infantiles. Escribe un cuento educativo para niños de {age_group} años.",
    "data_labels": {
        "protagonist": "Protagonista",
        "topic": "Tema Científico",
        "mission": "Trama/Misión"
    },
    "structure": (
        "ESTRUCTURA OBLIGATORIA:\n"
        "1. Título: Creativo y relacionado con la misión.\n"
        "2. Capítulos: Divide la historia en {num_chapters} capítulos cortos.\n"
        "3. Contenido: El tono debe ser divertido, seguro y fácil de leer. "
        "Asegúrate de explicar el concepto científico de forma natural dentro de la narrativa.\n"
        "Devuelve SOLO el JSON con el formato establecido."
    )
}
